...
AtomSet::AtomSet (int a)
{
	...
	cout << BOLDYELLOW << "-> Processing file " << "test.xyz" << RESET << endl ;
	...
	{
		cout << " " << endl ;
		std::cout << BOLDRED <<"-> ERROR: No atoms found in the file. ABORTING" << RESET << std::endl ;
		cout << " " << endl ;
		abort () ;
	}
 ...
 //            96            /__/  \            69
  //           69          _(<_   / )_          96
   //         6969        (__\_\_|_/__) 
	...
	file.close() ;
	std::cout << BOLDYELLOW <<"-> File test.xyz found" << RESET << std::endl ;
