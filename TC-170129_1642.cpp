...
void Atom::SetClusterIndex (int jj)
{
	clusterindex = jj ;
}
...
int main( int argc, const char* argv[] )
{
	...
	//----------------------------------------------------------------------------------------------------------------------------
	//----------------------------------------------------------------------------------------------------------------------------	
	unsigned int NodeType = 2 ;	// Tells the program what type of atoms will be clustered all other will be consider as sea atoms.
	...
	for ( size_t i = 0; i < 3; ++i ){ std::cout << "Cluster Index Sea = " << AtomSet_object.GetSea(i).GetClusterIndex() << std::endl ;}
	
	AtomSet_object.GetNode(0).SetX(7) ;
	
	cout << "x = " << AtomSet_object.GetNode(0).GetX() << std::endl ;
	for ( size_t i = 0; i < NodeAtoms; ++i ){ cout << "Cluster Index Node = " << AtomSet_object.GetNode(i).GetClusterIndex() << std::endl ;}
